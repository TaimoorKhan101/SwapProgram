...
use anchor_spl::{
    associated_token::AssociatedToken, token_interface::{transfer_checked, close_account, CloseAccount, Mint, TokenAccount, TokenInterface, TransferChecked}
};
use crate::Offer;
...
pub fn withdraw_and_close_vault(ctx: Context<TakeOffer>)-> Result<()>{
    let seeds = &[
      ...
      let cpi_context: CpiContext<TransferChecked> =
